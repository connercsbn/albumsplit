            ...
            <div>
                {activeStep === steps.length ? (
                    ...
                    <div>
                        <Typography className={classes.instructions}>
                            <p>
                                Pick a youtube album or audiobook whose
                                timecodes are in the description or comments,
                                and this will download the album, separate and
                                tag each track, and put it in a zip file
                            </p>
                            <SyncLoader
